...
public class MunicipioDAO {
    ...
    /**
     *Constructor parametrico que inicializa las variables de la clae MunicipioDAO
     * @param objM
     */
    public MunicipioDAO(Municipio objM) {
        this.objM = objM;
    }

    /**
     *Constructor basico que instancia la variables de tipo objeto en la clase MunicipioDAO
     */
    public MunicipioDAO() {
    ...
    public DefaultTableModel consulta(){
        ...
        try {
            ...
            ResultSet datos= consulta.executeQuery("select * from municipio");//Conjunto de datos, retorna los campos de los datos de Cliente con tabla
